...
%Cartesian coordinates of the image corners
if isempty(cor)
    lu_c = [1;1];
    ru_c = [m;1];
    ld_c = [1;n];
...
m2 = ceil(abs(max([lu2_c(1), ru2_c(1), ld2_c(1), rd2_c(1)]) - min([lu2_c(1), ru2_c(1), ld2_c(1), rd2_c(1)]))) + 1;
n2 = ceil(abs(max([lu2_c(2), ru2_c(2), ld2_c(2), rd2_c(2)]) - min([lu2_c(2), ru2_c(2), ld2_c(2), rd2_c(2)]))) + 1;

%% Compute the position rectification vector
origin_m = round(min([lu2_c(1), ru2_c(1), ld2_c(1), rd2_c(1)]));
origin_n = round(min([lu2_c(2), ru2_c(2), ld2_c(2), rd2_c(2)]));
