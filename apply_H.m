...
m2 = ceil(abs(max([lu2_e(1), ru2_e(1), ld2_e(1), rd2_e(1)]) - min([lu2_e(1), ru2_e(1), ld2_e(1), rd2_e(1)])));
n2 = ceil(abs(max([lu2_e(2), ru2_e(2), ld2_e(2), rd2_e(2)]) - min([lu2_e(2), ru2_e(2), ld2_e(2), rd2_e(2)])));
...
for i = 1:m2
    for j = 1:n2
        x_p = H\[i;j;1]; %A\b for inv(a)*b
        x_e = round([x_p(1)/x_p(3), x_p(2)/x_p(3)]); %%TODO: Use interp2
